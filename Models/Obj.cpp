...
struct objfile {
  ...
  objfile();
  objfile(std::string path, float r=0.5, float g=0.0, float b= 0.0, float ka = 0.3, float ks = 0.3) {
    bool res = loadObjFile(path, indices, indexed_vertices, indexed_uvs, indexed_normals);
    color[0] = r;
    color[1] = g;
    color[2] = b;
    k_ambient = ka;
